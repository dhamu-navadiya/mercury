//
//  OverdueDetailViewController.swift
//  Mercury App IOS
//
...
class OverdueDetailViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    @IBOutlet weak var overdueDetailTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        overdueDetailTableView.dataSource = self
        overdueDetailTableView.delegate = self
        
        let nibName0 = UINib(nibName: "OverdueContactTableViewCell", bundle: nil)
        overdueDetailTableView.register(nibName0, forCellReuseIdentifier: "overdue_contact_cell")
        
        let nibName = UINib(nibName: "OverdueDetailTableViewCell", bundle: nil)
        overdueDetailTableView.register(nibName, forCellReuseIdentifier: "overdue_detail_cell")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        loadData()
        overdueDetailTableView.reloadData()
    }
    ...
    func loadData() {
        ...
        let predicate1 = NSPredicate(format: "order_status == %@", "Overdue")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            let cell = overdueDetailTableView.dequeueReusableCell(withIdentifier: "overdue_contact_cell", for: indexPath) as! OverdueContactTableViewCell
            ...
            let cell = overdueDetailTableView.dequeueReusableCell(withIdentifier: "overdue_detail_cell", for: indexPath) as! OverdueDetailTableViewCell
