//
//  OverdueOrderViewController.swift
//  Mercury App IOS
//
...
class OverdueOrderViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    @IBOutlet weak var overdueOrderTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        showHideSearchBar()
        self.title = "Overdue Orders"
        
        overdueOrderTableView.dataSource = self
        overdueOrderTableView.delegate = self
        
        overdueOrderTableView.tableFooterView = UIView()
        ...
        requestOrder.predicate = NSPredicate(format: "order_status == %@", "Overdue")
        ...
        let nibName = UINib(nibName: "OverdueOrderTableViewCell", bundle: nil)
        overdueOrderTableView.register(nibName, forCellReuseIdentifier: "OverdueCell")
    }
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        self.overdueOrderTableView.reloadData()
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if numberOfRows > 0 {
            ...
            backgroundImage.image = #imageLiteral(resourceName: "overdue_order")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        counter = counter + 1
        let cell = tableView.dequeueReusableCell(withIdentifier: "OverdueCell", for: indexPath) as! OverdueOrderTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let overdueOrderDetailsVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "OverdueDetail") as! OverdueDetailViewController
        overdueOrderDetailsVC.stringPassed = receiptLblData[indexPath.row]
        self.navigationController?.pushViewController(overdueOrderDetailsVC, animated: true)
        self.overdueOrderTableView.deselectRow(at: indexPath, animated: true)
    }
}
...
class Orders {
    ...
    init(receiptNo: String, custName: String) {
