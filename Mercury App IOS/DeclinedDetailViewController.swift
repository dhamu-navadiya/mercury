//
//  DeclinedDetailViewController.swift
//  Mercury App IOS
//
...
class DeclinedDetailViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    @IBOutlet weak var declinedDetailTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        declinedDetailTableView.dataSource = self
        declinedDetailTableView.delegate = self
        
        let nibName0 = UINib(nibName: "DeclinedContactTableViewCell", bundle: nil)
        declinedDetailTableView.register(nibName0, forCellReuseIdentifier: "declined_contact_cell")
        
        let nibName = UINib(nibName: "DeclinedDetailTableViewCell", bundle: nil)
        declinedDetailTableView.register(nibName, forCellReuseIdentifier: "declined_detail_cell")
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        loadData()
        declinedDetailTableView.reloadData()
    }
    ...
    func loadData() {
        ...
        let predicate1 = NSPredicate(format: "order_status == %@", "Declined")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            let cell = declinedDetailTableView.dequeueReusableCell(withIdentifier: "declined_contact_cell", for: indexPath) as! DeclinedContactTableViewCell
            ...
            let cell = declinedDetailTableView.dequeueReusableCell(withIdentifier: "declined_detail_cell", for: indexPath) as! DeclinedDetailTableViewCell
            cell.setOrderViewLayout(itemCount: String(indexPath.row), prevImage: itemImageArray[indexPath.row - 1], desc: descriptionArray[indexPath.row - 1], titleArray: titleTextArray[indexPath.row - 1], detailArray: detailTextArray[indexPath.row - 1], orderSubIdArray: orderSubIdArray[indexPath.row - 1], counter: indexPath.row, txt_manufacturer: manufacturerLblData[indexPath.row - 1], txt_mobile: manufacturerMobileData[indexPath.row - 1], txt_email: manufacturerEmailData[indexPath.row - 1], orderDate: manufacturerDateLblData[indexPath.row - 1], deliveryDate: manufacturerDeliveryDateData[indexPath.row - 1])
