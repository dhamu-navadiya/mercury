...
class SentOrderViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    @IBOutlet weak var sentOrderTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        showHideSearchBar()
        self.title = "Sent Orders"
        
        sentOrderTableView.dataSource = self
        sentOrderTableView.delegate = self
        
        sentOrderTableView.tableFooterView = UIView()
        ...
        requestOrder.predicate = NSPredicate(format: "order_status == %@", "Sent")
        ...
        let nibName = UINib(nibName: "SentOrderTableViewCell", bundle: nil)
        sentOrderTableView.register(nibName, forCellReuseIdentifier: "sentorder_cell")
    }
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        self.sentOrderTableView.reloadData()
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if numberOfRows > 0 {
            ...
            backgroundImage.image = #imageLiteral(resourceName: "sent_order")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        counter = counter + 1
        let cell = tableView.dequeueReusableCell(withIdentifier: "sentorder_cell", for: indexPath) as! SentOrderTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let sentOrderDetailsVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "SentOrderDetails") as! SentOrderDetailsViewController
        sentOrderDetailsVC.stringPassed = receiptLblData[indexPath.row]
        self.navigationController?.pushViewController(sentOrderDetailsVC, animated: true)
        self.sentOrderTableView.deselectRow(at: indexPath, animated: true)
    }
}
