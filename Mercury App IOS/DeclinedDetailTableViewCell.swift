//
//  DeclinedDetailTableViewCell.swift
//  Mercury App IOS
//
...
class DeclinedDetailTableViewCell: UITableViewCell {
    ...
    func addTitleDetaiFields(xOff: CGFloat, yOff: CGFloat, width: CGFloat, height: CGFloat, titleText: String, detailText: String, cnt: Int)->UIView {
        ...
        let txtDetail = UITextField(frame: CGRect(x: 4, y: 0, width: vTitleDtlContainer.frame.width*0.57, height: 60))
