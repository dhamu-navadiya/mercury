...
class InProcessViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    @IBOutlet weak var inProcessOrderTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        self.tabBarController?.navigationItem.title = "In Process Orders"
        ...
        inProcessOrderTableView.dataSource = self
        inProcessOrderTableView.delegate = self
        
        inProcessOrderTableView.tableFooterView = UIView()
        
        loadData()
        
        let nibName = UINib(nibName: "InProcessOrderTableViewCell", bundle: nil)
        inProcessOrderTableView.register(nibName, forCellReuseIdentifier: "InProcessCell")
    }
    ...
    func loadData() {
        ...
        requestOrder.predicate = NSPredicate(format: "order_status == %@", "In Process")
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        self.inProcessOrderTableView.reloadData()
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if numberOfRows > 0 {
            ...
            backgroundImage.image = #imageLiteral(resourceName: "in_process")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        counter = counter + 1
        let cell = tableView.dequeueReusableCell(withIdentifier: "InProcessCell", for: indexPath) as! InProcessOrderTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let inProcessOrderDetailsVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "InProcessDetail") as! InProcessDetailViewController
        inProcessOrderDetailsVC.stringPassed = receiptLblData[indexPath.row]
        self.navigationController?.pushViewController(inProcessOrderDetailsVC, animated: true)
        self.inProcessOrderTableView.deselectRow(at: indexPath, animated: true)
    }
}
