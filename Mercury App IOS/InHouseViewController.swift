...
class InHouseViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    @IBOutlet weak var inHouseOrderTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        self.tabBarController?.navigationItem.title = "In House Orders"
        ...
        inHouseOrderTableView.dataSource = self
        inHouseOrderTableView.delegate = self
        
        inHouseOrderTableView.tableFooterView = UIView()
        
        let nibName = UINib(nibName: "InHouseTableViewCell", bundle: nil)
        inHouseOrderTableView.register(nibName, forCellReuseIdentifier: "InHouseCell")
    }
    ...
    func loadData() {
        ...
        requestOrder.predicate = NSPredicate(format: "order_status == %@", "In House")
        ...
        self.inHouseOrderTableView.reloadData()
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if numberOfRows > 0 {
            ...
            backgroundImage.image = #imageLiteral(resourceName: "in_house")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        counter = counter + 1
        let cell = tableView.dequeueReusableCell(withIdentifier: "InHouseCell", for: indexPath) as! InHouseTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let inHouseOrderDetailsVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "InHouseDetail") as! InHouseDetailViewController
        inHouseOrderDetailsVC.stringPassed = receiptLblData[indexPath.row]
        self.navigationController?.pushViewController(inHouseOrderDetailsVC, animated: true)
        self.inHouseOrderTableView.deselectRow(at: indexPath, animated: true)
    }
}
