//
//  ReadyOrderViewController.swift
//  Mercury App IOS
//
...
class ReadyOrderViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    @IBOutlet weak var readyOrderTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        self.tabBarController?.navigationItem.title = "Ready Orders"
        ...
        readyOrderTableView.dataSource = self
        readyOrderTableView.delegate = self
        
        readyOrderTableView.tableFooterView = UIView()
        
        loadData()
        
        let nibName = UINib(nibName: "ReadyTableViewCell", bundle: nil)
        readyOrderTableView.register(nibName, forCellReuseIdentifier: "ReadyCell")
    }
    ...
    func loadData() {
        ...
        requestOrder.predicate = NSPredicate(format: "order_status == %@", "Ready")
        ...
        self.readyOrderTableView.reloadData()
    }
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if numberOfRows > 0 {
            ...
            backgroundImage.image = #imageLiteral(resourceName: "ready")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        counter = counter + 1
        let cell = tableView.dequeueReusableCell(withIdentifier: "ReadyCell", for: indexPath) as! ReadyTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let readyOrderDetailsVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ReadyDetail") as! ReadyDetailViewController
        readyOrderDetailsVC.stringPassed = receiptLblData[indexPath.row]
        self.navigationController?.pushViewController(readyOrderDetailsVC, animated: true)
        self.readyOrderTableView.deselectRow(at: indexPath, animated: true)
    }
}
